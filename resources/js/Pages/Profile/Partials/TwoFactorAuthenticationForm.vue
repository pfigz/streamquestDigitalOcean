...
<template>
    <JetActionSection>
        ...
        <template #description>
            <div class="text-gray-400">Add additional security to your account using two factor authentication.</div>
        </template>

        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-gray-900">
                <div class="text-gray-100">You have enabled two factor authentication.</div>
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-900">
                <div class="text-gray-100">Finish enabling two factor authentication.</div>
            </h3>

            <h3 v-else class="text-lg font-medium text-gray-900">
                <div class="text-gray-100">You have not enabled two factor authentication.</div>
            </h3>

            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    <div class="text-gray-400">When two factor authentication is enabled, you will be prompted for a secure, random token during authentication. You may retrieve this token from your phone's Google Authenticator application.</div>
                </p>
            </div>
